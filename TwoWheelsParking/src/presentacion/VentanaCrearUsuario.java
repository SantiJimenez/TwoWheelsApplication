...
public class VentanaCrearUsuario extends JFrame implements ActionListener{
	 ...
	 * Create the frame.
	 */
	public VentanaCrearUsuario(ConectorComponentes cc) {
		this.cc = cc;		
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(accion == "CREAR") {
			cc.getUsuarios().crearUsuario(Integer.parseInt(txtDocumento.getText()), txtNombre.getText(), txtApellido.getText(), txtTelefono.getText(), comboBox.getSelectedItem().toString());
